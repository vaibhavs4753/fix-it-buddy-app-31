...
const ClientHome = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-neutral-50 to-white">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-white to-white pt-20 pb-32">
              ...
              {activeRequests > 0 ? (
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-black">Check their status or track your technician</p>
                  </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-black mb-4">You don't have any active service requests</p>
                  <Link to="/client/services">
