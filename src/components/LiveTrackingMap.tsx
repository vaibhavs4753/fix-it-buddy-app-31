...
const LiveTrackingMap: React.FC<LiveTrackingMapProps> = ({ 
  ...
  useEffect(() => {
    ...
    clientEl.style.backgroundColor = '#3b82f6';
  ...
  useEffect(() => {
    ...
    techEl.style.backgroundColor = '#10b981';
    ...
    <div className="relative w-full h-full">
      ...
      {!technician && (
        <div className="absolute top-4 left-4 bg-white p-3 rounded-lg shadow-lg">
          <p className="text-sm text-gray-600">🔍 Looking for nearby technicians...</p>
        </div>
      )}
        ...
        <div className="absolute top-4 left-4 bg-white p-3 rounded-lg shadow-lg max-w-xs">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">{technician.serviceType} • ⭐ {technician.rating}</p>
            </div>
          </div>
        </div>
      )}
