    ...
    <div className="service-background flex flex-col">
      <div className="flex-grow flex items-center justify-center p-4">
        <div className={`max-w-md w-full space-y-8 p-8 bg-card/90 backdrop-blur-sm rounded-xl shadow-2xl border border-white/10 transition-all ${isAnimating ? 'scale-95 opacity-50' : ''}`}>
          ...
          <div className="mt-10">
            <h2 className="text-2xl font-medium text-center mb-6 text-foreground">I am a...</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <button
                onClick={() => handleSelection('client')}
                className={`group relative p-6 border-2 rounded-xl transition-all ${selectedType === 'client' ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'}`}
              >
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-medium text-foreground">Client</h3>
                  <p className="text-center text-muted-foreground mt-2">I need a service</p>
                </div>
              </button>
              
              <button
                onClick={() => handleSelection('technician')}
                className={`group relative p-6 border-2 rounded-xl transition-all ${selectedType === 'technician' ? 'border-accent bg-accent/10' : 'border-border hover:border-accent'}`}
              >
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-medium text-foreground">Technician</h3>
                  <p className="text-center text-muted-foreground mt-2">I provide a service</p>
                </div>
              </button>
            </div>
          </div>
